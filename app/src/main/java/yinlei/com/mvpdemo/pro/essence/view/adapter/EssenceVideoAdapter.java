...
import yinlei.com.mvpdemo.pro.essence.view.views.CircleNetworkImageImage;
...
//        holder.tv_comment.setText(postList.getComment());
    ...
    public class VideoAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoAdapterViewHolder(View itemView, boolean isItem) {
            super(itemView);
//            if (isItem) {
//                iv_header = (com.tz.dream.budejie.pro.essence.view.views.CircleNetworkImageImage) itemView
